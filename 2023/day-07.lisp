...
(defun solve (part)
  (let ((hands (loop for (hand bet) in (get-input part)
    ...
    (loop for hand in (sort-hands hands)
          for i from 1
          sum (* i (third hand)))))
